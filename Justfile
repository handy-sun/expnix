...
nix_inputs := "nixpkgs nix-darwin nixos-wsl home-manager system-manager helix-dev sops-nix mark-shot flyline daeuniverse rust-analyzer-mcp-src qt-rules-mcp-src"
my_inputs := "githand my-dotzsh my-dotfiles my-dotvim my-nvimdots my-wezterm my-helix-config sbtpl"
